...
export const createProduct = async (req, res, next) => {
  try {
    let { name, slug, description, price, discountPrice, shippingCharge, category, brand, colors, sizes, stock, sku, productLink, images, isFeatured, isActive } = req.body;
    ...
    const product = new Product({
      name, slug, description, price, discountPrice, shippingCharge: shippingCharge || 0, category: categoryId, brand, colors: colors || [], sizes: sizes || [], stock, sku, productLink: productLink || "", images, isFeatured, isActive
    });
